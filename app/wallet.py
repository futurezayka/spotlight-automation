...
from app.selectors import (
    ...
    SIGN_MESSAGE_SELECTOR, SIGH_IN_CONFIRM_SELECTOR, IMPORT_WALLET_SELECTOR
)
...
class WalletConnect:
    ...
    def connect(self):
        WebDriverWait(self.driver, 15).until(ec.presence_of_element_located((By.XPATH, CONNECT_WALLET_BUTTON_SELECTOR)))
        ...
        WebDriverWait(self.driver, 15).until(ec.element_to_be_clickable((By.XPATH, CONNECT_SELECTOR)))
        self.driver.find_element(By.XPATH, CONNECT_SELECTOR).click()
        WebDriverWait(self.driver, 15).until(ec.element_to_be_clickable((By.XPATH, APPROVE_SELECTOR)))
        self.driver.find_element(By.XPATH, APPROVE_SELECTOR).click()
        self.switch_window(-2, 3)
        WebDriverWait(self.driver, 15).until(ec.element_to_be_clickable((By.XPATH, SIGN_MESSAGE_SELECTOR)))
        self.driver.find_element(By.XPATH, SIGN_MESSAGE_SELECTOR).click()
        self.switch_window(-1, 4)
        WebDriverWait(self.driver, 15).until(ec.element_to_be_clickable((By.XPATH, SIGH_IN_CONFIRM_SELECTOR)))
